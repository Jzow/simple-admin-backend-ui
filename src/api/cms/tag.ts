...
enum Api {
  CreateTag = '/cms-api/article_tag/create',
  UpdateTag = '/cms-api/article_tag/update',
  GetTagList = '/cms-api/article_tag/list',
  DeleteTag = '/cms-api/article_tag/delete',
  GetTagById = '/cms-api/article_tag',
}
